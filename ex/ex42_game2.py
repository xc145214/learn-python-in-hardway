...
class Engine(object):
    ...
    def __init__(self, sence_map, hero):
        self.sence_map = sence_map
        self.hero = hero

    def play(self):
        current_sence = self.sence_map.opening_scene()

        while True:
            print "\n-----------"
            next_scene_name = current_sence.enter(self.hero)
            current_sence = self.sence_map.next_scene(next_scene_name)
